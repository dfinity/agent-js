...
- **New documentation website**: The documentation website available at [agent-js.icp.xyz](https://agent-js.icp.xyz) has been renewed. It is now build using the [Starlight](https://starlight.astro.build/) framework.
