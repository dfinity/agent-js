...
import {
  IRelyingPartyAuthenticationSession,
  RelyingPartyAuthenticationSessionSerializer,
} from '../session';
...
export default function RelyingPartyDemo(props: {
  ...
  const [goalScope, setGoalScope] = React.useState<string>(
    'canisterAPrincipalText canisterBPrincipalText',
  );
  ...
  return (
    <>
      ...
      <p>
        Click the button below to authenticate with the Internet Computer, authorizing the following
        session identity:
      </p>
