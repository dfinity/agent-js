...
var idlFactory = function (_a) {
    var IDL = _a.IDL;
    var Value = IDL.Rec();
    var CreateReleaseArgs = IDL.Record({
        id: IDL.Text,
        features: IDL.Text,
        size: IDL.Nat64,
        version: IDL.Text,
    ...
    var UserView = IDL.Record({
        updated_at: IDL.Nat64,
        metadata: IDL.Vec(IDL.Tuple(IDL.Text, Value)),
        created_at: IDL.Nat64,
        canisters: IDL.Vec(IDL.Principal),
    });
    var Result = IDL.Variant({ Ok: UserView, Err: IDL.Text });
    var AppBug = IDL.Record({
    ...
    var FromUserRecord = IDL.Record({ user_id: IDL.Principal });
    var FromCanisterRecord = IDL.Record({
        canister_version: IDL.Opt(IDL.Nat64),
        canister_id: IDL.Principal,
    });
    var CanisterChangeOrigin = IDL.Variant({
        from_user: FromUserRecord,
        from_canister: FromCanisterRecord,
    });
    var CreationRecord = IDL.Record({ controllers: IDL.Vec(IDL.Principal) });
    var CanisterInstallMode = IDL.Variant({
        reinstall: IDL.Null,
        upgrade: IDL.Null,
        install: IDL.Null,
    });
    var CodeDeploymentRecord = IDL.Record({
        mode: CanisterInstallMode,
        module_hash: IDL.Vec(IDL.Nat8),
    });
    var CanisterChangeDetails = IDL.Variant({
        creation: CreationRecord,
        code_deployment: CodeDeploymentRecord,
        controllers_change: CreationRecord,
        code_uninstall: IDL.Null,
    });
    var CanisterChange = IDL.Record({
        timestamp_nanos: IDL.Nat64,
        canister_version: IDL.Nat64,
        origin: CanisterChangeOrigin,
        details: CanisterChangeDetails,
    });
    var CanisterInfoResponse = IDL.Record({
        controllers: IDL.Vec(IDL.Principal),
        module_hash: IDL.Opt(IDL.Vec(IDL.Nat8)),
        recent_changes: IDL.Vec(CanisterChange),
        total_num_changes: IDL.Nat64,
    });
    var HelperError = IDL.Variant({
    ...
    var AppSystemError = IDL.Variant({
    ...
    var Result_1 = IDL.Variant({ Ok: ReleaseView, Err: AppSystemError });
    var CanisterStatusType = IDL.Variant({
        stopped: IDL.Null,
        stopping: IDL.Null,
        running: IDL.Null,
    });
    var DefiniteCanisterSettings = IDL.Record({
        freezing_threshold: IDL.Nat,
        controllers: IDL.Vec(IDL.Principal),
        memory_allocation: IDL.Nat,
        compute_allocation: IDL.Nat,
    });
    var QueryStats = IDL.Record({
        response_payload_bytes_total: IDL.Nat,
        num_instructions_total: IDL.Nat,
        num_calls_total: IDL.Nat,
        request_payload_bytes_total: IDL.Nat,
    });
    var CanisterStatusResponse = IDL.Record({
    ...
    var UserCanisterStatus = IDL.Record({
        version: IDL.Text,
        canister_status: CanisterStatusResponse,
    });
    var UserStatus = IDL.Variant({
        Unregistered: IDL.Null,
        SingleCanister: IDL.Principal,
        MultipleCanister: IDL.Vec(IDL.Principal),
        Registered: IDL.Null,
    });
    var LoadRelease = IDL.Record({ total: IDL.Nat64, chunks: IDL.Nat64 });
    var SystemCanisterStatus = IDL.Record({
    ...
    return IDL.Service({
        ...
        deprecate_release: IDL.Func([IDL.Text, IDL.Vec(IDL.Nat8)], [ReleaseView], []),
        ...
        load_wasm: IDL.Func([IDL.Vec(IDL.Nat8), IDL.Vec(IDL.Nat8)], [LoadRelease], []),
